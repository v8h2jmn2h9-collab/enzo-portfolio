# Enzo Guichard — Mechanical Engineering Portfolio

A static, dependency-free portfolio with real project case studies and responsive layouts.

The HTML, CSS, JavaScript, selected images and PDF documents in this repository are the complete website. Serve this folder with a static web server. All pages have their own directory and `index.html`, so direct links and refreshes work without a router or server-side application.
